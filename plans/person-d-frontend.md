...
Merged. Note: post-hackathon the single `LiveBoard` was generalized to a `LiveBoards` grid with per-game termination badges (see [followup-4-frontend-polish.md](followup-4-frontend-polish.md)).
